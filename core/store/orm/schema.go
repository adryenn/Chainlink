...
type ConfigSchema struct {
	...
	BlockHistoryEstimatorBatchSize             uint32          `env:"GAS_UPDATER_BATCH_SIZE"`
	BlockHistoryEstimatorBlockDelay            uint16          `env:"GAS_UPDATER_BLOCK_DELAY"`
	BlockHistoryEstimatorBlockHistorySize      uint16          `env:"GAS_UPDATER_BLOCK_HISTORY_SIZE"`
	BlockHistoryEstimatorEnabled               bool            `env:"GAS_UPDATER_ENABLED"`
	BlockHistoryEstimatorTransactionPercentile uint16          `env:"GAS_UPDATER_TRANSACTION_PERCENTILE" default:"60"`
